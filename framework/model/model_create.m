...
% es en este script donde se inicializa el modelo, las variables más
% importantes son:
% filters -> hacer traqueo, como es un arreglo es en esta estructura donde
% deberían quedar guardados los filtros que va detectando el framework
% 
% features -> viene del archivo conf, donde se setean los parametros de las
% dimenciones de las sub ventanas que analizan la imagen.
% 
% 
