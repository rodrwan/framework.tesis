...
if nargin < 5
  ...
  [peak, I] = max(aspects);
  aspect = exp(xx(I)); % maximo de la distribución de aspect ratios.

  % pick 20 percentile area
  % A: es el área del 20° percentil(?) del total de areas del conjunto de
  % imágenes dadas, acotada entre 3000(?) y 5000(?)
  areas = sort(h.*w);
